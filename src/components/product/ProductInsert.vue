      ...
      <table>
        ...
        <tr>
          ...
          <td class="product_txt">
            <select id="product_major_category" class="product_major_category" v-model="test.product_major_category" @change="selectMajorCategory(this)" >
              <option v-for="product_major_category in test.majorCategoryList" :key="product_major_category.major" :value="product_major_category.value">{{product_major_category.major}}</option>
            </select>
          </td>
        </tr>
        <tr>
          ...
          <td class="product_txt">
            <select id="product_middle_category" class="product_middle_category" v-model="test.product_middle_category" @change="selectMiddleCategory(this)">
              <option v-for="product_middle_category in test.middleCategoryList" :key="product_middle_category.middle" :value="product_middle_category.value">{{product_middle_category.middle}}</option>
            </select>
          </td>
        </tr>
        <tr>
          ...
          <td class="product_txt">
            <select id="product_small_category" class="product_small_category" v-model="test.product_small_category" @change="selectSmallCategory(this)">
              <option v-for="product_small_category in test.smallCategoryList" :key="product_small_category.small" :value="product_small_category.value">{{product_small_category.small}}</option>
            </select>
          </td>
        </tr>
        <tr>
          <td class="product_tit">제품회사</td>
          <td class="product_txt"><input type="text" id="product_corp" class="product_corp" v-model="test.product_corp" autocomplete="off"><span class="product_txt_ex">ex) 씨제이올리브영 주식회사</span></td>
        </tr>
        <tr>
          <td class="product_tit">제품개수</td>
          <td class="product_txt"><input type="text" id="product_cnt" class="product_cnt" v-model="test.product_cnt" autocomplete="off"><span class="product_txt_span">개</span></td>
        </tr>
        <tr>
          <td class="product_tit">제품용량</td>
          <td class="product_txt"><input type="text" id="product_amount" class="product_amount" v-model="test.product_amount" autocomplete="off"><span class="product_txt_ex">단위 입력바랍니다. ex) ml, 매, g 등</span></td>
        </tr>
        <tr>
          <td class="product_tit">제품주요사양</td>
          <td class="product_txt"><input type="text" id="product_func" class="product_func" v-model="test.product_func" autocomplete="off"><span class="product_txt_ex">ex) 모든피부용, 건성, 지성 등</span></td>
        </tr>
        <tr>
          <td class="product_tit">제품사용기한(또는 개봉 후 사용기간)</td>
          <td class="product_txt"><input type="text" id="product_limit" class="product_limit" v-model="test.product_limit" autocomplete="off"></td>
        </tr>
        <tr>
          <td class="product_tit">제품사용방법</td>
          <td class="product_txt"><input type="text" id="product_way" class="product_way" v-model="test.product_way" autocomplete="off"></td>
        </tr>
        <tr>
          <td class="product_tit">제품제조업자/판매업자</td>
          <td class="product_txt"><input type="text" id="product_manufacturer" class="product_manufacturer" v-model="test.product_manufacturer" autocomplete="off"></td>
        </tr>
        <tr>
          <td class="product_tit">제품제조국</td>
          <td class="product_txt"><input type="text" id="product_produce_country" class="product_produce_country" v-model="test.product_produce_country" autocomplete="off"></td>
        </tr>
        <tr>
          <td class="product_tit">화장품법에 따라 기재해야 하는 모든 성분</td>
          <td class="product_txt"><textarea id="product_ingredient" class="product_ingredient" v-model="test.product_ingredient"></textarea></td>
        </tr>
        <tr>
          <td class="product_tit">기능성 화장품 식품의약품안전처 심사필 여부</td>
          <td class="product_txt"><input type="text" id="product_evaluate" class="product_evaluate" v-model="test.product_evaluate" autocomplete="off"></td>
        </tr>
        <tr>
          <td class="product_tit">사용할 때의 주의사항</td>
          <td class="product_txt"><textarea id="product_attention" class="product_attention" v-model="test.product_attention" autocomplete="off"></textarea></td>
        </tr>
        <tr>
          <td class="product_tit">품질보증기준</td>
          <td class="product_txt"><input type="text" id="quality_standard" class="quality_standard" v-model="test.quality_standard" autocomplete="off"></td>
        </tr>
        <tr>
          <td class="product_tit">소비자상담 전화번호</td>
          <td class="product_txt"><input type="text" id="consultation_number" class="consultation_number" v-model="test.consultation_number" autocomplete="off"></td>
        </tr>
...
export default {
  ...
  methods: {
    ...
    selectMajorCategory() {
      this.test.product_major_category = this.test.product_major_category
    },
    selectMiddleCategory() {
      this.test.product_middle_category = this.test.product_middle_category
    },
    selectSmallCategory() {
      this.test.product_small_category = this.test.product_small_category
    },
    async productInsert() {
      // let 제품등록파라미터 = {
